...
<body>
    <form method="post">
        <div class="container">
            <div class="row mt-5">
                <div class="col-10">
                    <h1><i class="fa fa-store"></i> InvicShoes</h1>
                </div>
            ...
            <div class="row">
                <?php if(isset($_GET['delkey']) && isset($arrProducts[$_GET['delkey']])): ?>
                    ...
                    <div class="col-md-8 col-sm-6 mb-4">                
                        ...
                        <input type="hidden" name="hdnSize" value="<?php echo $_GET['c']; ?>">
                        <input type="hidden" name="hdnQuantity" value="<?php echo $_GET['q']; ?>">

                        <h3 class="title">Size: <?php echo $_GET['c']; ?></h3>                        
                        <hr>
